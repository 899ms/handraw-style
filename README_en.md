...
This repository curates **275 distinct hand-drawn illustration styles** (`001`–`275`) and **118 composition layout patterns** (`SC-*` Social Cards, `IG-*` Infographics, `SB-*` Comic Storyboards).
...
| :--- | :--- |
| **Vague style descriptions lead to style drift** | **Numbered Indexing**: 275 systematically categorized illustration styles, eliminating guess-and-pray prompting. |
...
- **Explicitly Calibrated Models (e.g., `gpt-image-2`)**: Full activation hierarchy for all 275 styles: Style/Author Name → Positive Core Traits → Reference Image only when traits alone cannot reliably trigger the style, avoiding unnecessary image passing that might over-constrain the composition.
...
- 🖼️ **[👉 Browse All Style Sheets (001–275 Full Visual Contact Sheets)](STYLES_en.md)**
- 📄 **[View Detailed Style Metadata (275 Styles Table & Core Traits)](styles_200_reorganized.md)**
...
In addition to 275 illustration styles, this library includes **118 composition layout patterns**, covering social cards, data infographics, and multi-panel storyboards. Combine any style with any layout with a single command.
