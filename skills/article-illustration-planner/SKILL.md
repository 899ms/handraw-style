...
* (optional) a hand-drawn style number (`001`–`279`) and/or theme color (`C-01`–`C-30`). If omitted, the Skill automatically analyzes the article's mood, domain, and audience to recommend an optimal cohesive style and theme color combination.
