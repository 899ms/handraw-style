...
<dialog id="preview" aria-labelledby="dialog-label"><img id="preview-image" alt=""><div class="dialog-actions"><p class="dialog-label" id="dialog-label"></p><button class="copy" id="copy" type="button">复制排版提示词</button><button class="close" type="button">关闭 ×</button></div><p class="dialog-tip">图片出于展示目的做了压缩，AI出的图字迹是很清晰的</p></dialog>
